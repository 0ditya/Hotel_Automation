...
DROP TABLE IF EXISTS `food_menu_item`;
...
LOCK TABLES `food_menu_item` WRITE;
/*!40000 ALTER TABLE `food_menu_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_menu_item` ENABLE KEYS */;
UNLOCK TABLES;
